        ...
        <MDBContainer style={{marginTop: "25vh", marginBottom: "50vh"}}>
            <MDBRow >
                <MDBCol md="12" className="white-text text-center">
                    ...
                    <h4 className="subtext-header h4-responsive mt-2 mb-4">Welcome to Creative Agency. We are here to give digital life to your business corporate.</h4>
                    <MDBBtn color="info" ><MDBIcon icon="home" className="mr-2" /> Visit More</MDBBtn>
                </MDBCol>
            </MDBRow>
        </MDBContainer>
    );
